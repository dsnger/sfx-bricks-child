...
class AdminPage
{
  public static string $menu_slug = 'sfx-company-logo';
  public static string $page_title = 'Company Logo';
  public static string $description = 'Configure and manage the company logo which can be used everywhere in pages or posts via shortcode.';
    ...
    <div class="wrap sfx-logo-admin-page">
      ...
      <div class="sfx-logo-admin-columns">
        ...
        <div class="sfx-logo-admin-column sfx-logo-settings-column">
            ...
            <h2><?php esc_html_e('Logo Settings', 'sfxtheme'); ?></h2>
