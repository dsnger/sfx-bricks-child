...
class Settings
{
    ...
    public static function render_styles_section(): void
    {
      ...
      <details class="sfx-token-mapping-summary">
        ...
        <p><code><?php echo esc_html('Wireup at :root: --cg-gutter (chains to --container-padding-inline, then --container-padding-horizontal), --cg-content (chains to --max-screen-width), --cg-feature (fixed 2100px default), --cg-feature-max (fixed 2450px default), --cg-gap (chains to --grid-gap then --space-m), --cg-split (split-breakout left-column fraction, default 0.5).'); ?></code></p>
