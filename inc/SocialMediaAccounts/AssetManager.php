...
class AssetManager
{
    ...
    {
        // Only load assets on sfx_social_account post type pages
        ...
        if (file_exists($css_file)) {
            wp_enqueue_style('sfx-social-accounts-admin', get_stylesheet_directory_uri() . '/inc/SocialMediaAccounts/assets/admin-style.css', [], filemtime($css_file));
        }

        if (file_exists($js_file)) {
            wp_enqueue_script('sfx-social-accounts-admin', get_stylesheet_directory_uri() . '/inc/SocialMediaAccounts/assets/admin-script.js', ['jquery'], filemtime($js_file), true);
        }
    }
} 