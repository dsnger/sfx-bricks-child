...
## [0.10.1_rc] - 2026-01-19

Enhanced Dashboard Form Submissions: clickable links to Bricks admin, parsed form fields (name, email, subject), total count badge, View All button, improved card layout with form icons and view actions, responsive styles, empty state handling
...
### Added
- **Localization**: German translations for dashboard updates section (View Updates, updates available, Plugin/Plugins, Theme/Themes)

## [0.9.6] - 2026-01-12

### Fixed
- **Custom Dashboard**: Site health status calculation now matches WordPress native weighted formula

## [0.9.5] - 2026-01-12

### Fixed
- **Custom Dashboard**: Site health status now matches WordPress native behavior (issue-based, not percentage-based)
...
- **WPOptimizer**: Simplified Controller code and improved Bricks Builder context checks
...
- **GitHub Updater**: Authentication support and improved error handling for private repos
